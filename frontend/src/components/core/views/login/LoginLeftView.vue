...
<style lang="scss" scoped>
  ...
  .login-left-view {
    ...
    .logo-mark {
      ...
      border: 1px solid rgba(122, 159, 222, 0.16);
      border-radius: 20px;
      backdrop-filter: blur(12px);
      box-shadow: 0 18px 40px rgba(84, 114, 167, 0.08);
    }
    ...
    .hero-copy {
      ...
      max-width: 460px;
      animation: slideInLeft 0.75s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards;
      ...
      .hero-line {
        ...
        height: 188px;
        border-radius: 999px;
        background: linear-gradient(180deg, #5a8dee 0%, #86d3ff 100%);
        box-shadow: 0 10px 30px rgba(90, 141, 238, 0.22);
      }
  ...
  .dark .login-left-view {
    ...
    .hero-copy {
      .hero-line {
        background: linear-gradient(180deg, #6ea8ff 0%, #5eead4 100%);
        box-shadow: 0 10px 30px rgba(72, 157, 255, 0.2);
      }

      .hero-badge {
        color: rgba(154, 196, 255, 0.9);
      }
